...
public class RescheduleServiceCreateRequestTest {
    ...
    void TC01_UserNotFound_ByEmail_Returns401() {
        ...
        ResponseData<Integer> response = rescheduleService.createRequest(SESSION_ID, "2026-05-01", "20:00", "Bận việc", EMAIL);
    ...
    void TC04_NotSessionOwner_Returns403() {
        ...
        ResponseData<Integer> response = rescheduleService.createRequest(SESSION_ID, "2026-05-01", "20:00", "Bận", EMAIL);
    ...
    void TC06_InvalidDateFormat_Returns400() {
        ...
        ResponseData<Integer> response = rescheduleService.createRequest(SESSION_ID, "28/04/2026", "20:00", "Bận", EMAIL);
    ...
    void TC07_OriginalSessionInPast_Returns400() {
        ...
        ResponseData<Integer> response = rescheduleService.createRequest(SESSION_ID, validFutureDate, "20:00", "Bận", EMAIL);
    ...
    void TC08_NewScheduleMatchesOldSchedule_Returns400() {
        ...
        ResponseData<Integer> response = rescheduleService.createRequest(SESSION_ID, sameDateStr, sameTimeStr, "Bận", EMAIL);
    ...
    void TC09_ConflictWithConfirmedSession_Returns400() {
        ...
        when(classSessionRepository.countConflictsInDateRange(eq(teacher.getUserId()), any(), any(), eq("20:00"), eq(SESSION_ID)))
                .thenReturn(1L);
    ...
    void TC10_ConflictWithPendingRequest_Returns400() {
        ...
        String futureDate = LocalDate.now().plusDays(2).toString();
        when(classSessionRepository.countConflictsInDateRange(anyInt(), any(), any(), anyString(), anyInt())).thenReturn(0L);
    ...
    void TC12_CreateRequestSuccess_NotifiesManagers_Returns200() {
        ...
        verify(notificationService, times(1)).sendRescheduleRequestForManager(eq(20L), anyString(), anyString(), anyString());
    }
    ...
    void TC13_CreateRequestSuccess_NotificationFails_DoesNotRollback() {
        ...
        doThrow(new RuntimeException("Notification failed"))
                .when(notificationService).sendRescheduleRequestForManager(anyLong(), anyString(), anyString(), anyString());
