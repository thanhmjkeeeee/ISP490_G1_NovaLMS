            ...
            for (ClassSession session : clazz.getSessions()) {
                ...
                for (SessionLesson sl : sessionLessons) {
                    ...
                    LessonResponseDTO lDTO = LessonResponseDTO.builder()
                            ...
                            .passed(latestResult != null ? latestResult.getPassed() : null)
                ...
                sessionDTOs.add(SessionDetailDTO.builder()
                        ...
                        .sessionDate(session.getSessionDate() != null ? session.getSessionDate().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")) : "")
                        .dayOfWeek(session.getSessionDate() != null ? session.getSessionDate().getDayOfWeek().getValue() : 1)
